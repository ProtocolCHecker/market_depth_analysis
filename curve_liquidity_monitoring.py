...
#     def fetch_market_depth(self, pool_address: str, token1_address: str, token2_address: str) -> Optional[dict]:
#         """
#         Fetch market depth data from the API
...
#     config_loaded = fetcher.load_pools_config("pools_config.json")
...
#         fetcher.analyze_pair_by_name("OUSD/USDC")
